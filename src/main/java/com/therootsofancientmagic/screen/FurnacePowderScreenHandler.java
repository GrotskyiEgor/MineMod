...
public class FurnacePowderScreenHandler extends ScreenHandler {
    private final Inventory inventory;
    private final PropertyDelegate propertyDelegate;
    public final FurnacePowderBlockEntity blockEntity;

    public FurnacePowderScreenHandler(int syncId, PlayerInventory inventory, PacketByteBuf buf) {
    ...
    public FurnacePowderScreenHandler(int syncId, PlayerInventory playerInventory, BlockEntity blockEntity, PropertyDelegate arrayPropertyDelegate) {
        ...
        this.blockEntity = ((FurnacePowderBlockEntity) blockEntity);
