...
public class AquaStaff extends Item {
    ...
    /**
     * Создаёт ледяную конструкцию 5x5x5.
     *
     * Снаружи:
     * ICE
     *
    ...
    private void createIceDome(
        ...
        /*
         * Поднимаем центр конструкции на 2 блока.
         *
         * Размер:
         *
         * -2 ... +2
        ...
        for (int x = -HALF_SIZE; x <= HALF_SIZE; x++) {
            ...
            for (int y = -HALF_SIZE; y <= HALF_SIZE; y++) {
                ...
                for (int z = -HALF_SIZE; z <= HALF_SIZE; z++) {
                    ...
                    /*
                     * Проверяем, является ли блок
                     * частью внешней оболочки.
                     *
                     * Если хотя бы одна координата
                     * находится на границе куба,
                     * ставим лёд.
                     */
                    ...
                    if (isOuterLayer) {
                        ...
                        /*
                         * Внутри конструкции находится вода.
                         */
                        world.setBlockState(
                                blockPos,
    ...
    /**
     * Определяет блок, в который смотрит игрок.
     */
